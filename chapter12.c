...
// functions defination steps :
// 1 declare fun (isska use karenge taki future function declarations ka syntax kame):
//  def {fun} (\ {args body} {def (head args) (\ (tail args) body)})
//2 . example function creation :fun {unpack f xs} {eval (join (list f) xs)}
// 2nd function creation :fun {pack f & xs} {f xs}
// 3 workin: 1def {uncurry} pack 2 def {curry} unpack
//4 call  and use : curry + {5 6 7} output: 18
        // uncurry head 5 6 7 output : 18
